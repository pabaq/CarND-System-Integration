...
NUM_LOOKAHEAD_PUB = 200  # number of waypoints to publish in ego vehicle's front
NUM_LOOKAHEAD_LIGHT = 150  # traffic light detection zone in number of waypoints
